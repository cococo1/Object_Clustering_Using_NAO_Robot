...
cv::Mat ObjectDetector:: computeForegroundMask(Image& image, Image& background)
{
    ...
    cv::imwrite("/Users/Max/Desktop/maskWithShadow.jpg", mask);
    cv::waitKey(0);
    ...
    cv::imwrite("/Users/Max/Desktop/maskWithoutShadow.jpg", mask);
    ...
    cv::Mat& threshold_output)
{
    ...
    if (SHOW_IMAGES)
    {
        ...
        for( int i = 0; i< bestContours.size(); i++ )
        {
            ...
            drawContours( drawing, bestContours, i, color, 2, 8, hierarchy, 0, cv::Point() );
        }
        
        
        cv::imshow( "After contours", drawing );
        cv::imwrite("/Users/Max/Desktop/contours.jpg", drawing);
                    ...
                    cv::Mat src)
{
    ...
    cv::imwrite("/Users/Max/Desktop/afterDetection.jpg", drawing);
    cv::waitKey();
                                                        ...
                                                        Image& background)
{
    ...
    cv::imwrite("/Users/Max/Desktop/recolored_src.jpg", recolored_src);
    ...
    cv::imwrite("/Users/Max/Desktop/src_gray.jpg", src_gray);
    cv::waitKey();
